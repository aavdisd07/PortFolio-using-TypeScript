  ...
  return (
    ...
    <Modal.Content className='!rounded-3xl'>
      <Modal.Header className="!bg-bgColor !border-primaryColor !border-2 !border-b-0 !rounded-tl-3xl  !rounded-tr-3xl   " >
        <Modal.Title data-autofocus className='!text-3xl  flex gap-4  items-center text-white !font-bold'>{props.title}  {props.live == true && (
            <Badge size="lg"
      ...
      <Group  mt="md" justify='space-between'>
        ...
        <Button  variant="outline" size="lg"color="primaryColor" className="!bg-primaryColor !text-bgColor" fullWidth mt="md" radius="md">
           view Code 
        </Button>
        </a>
        <a className=' !w-[48%]' target='_blank' href={props.link}>
        <Button  variant="outline" size="lg" color="#64FADA"  fullWidth mt="md" radius="md">
           view Live
        </Button>
        </a>
